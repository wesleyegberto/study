/**
 * @author Wesley Egberto de Brito Data: 08/08/2011
 * 
...
public class Servidor {
	...
	void go() {
		...
		while(true) {
			try {
				...
				deliveryMessage(nickClient + " entrou no chat da BSE na porta.");
	...
	class SocketClient implements Runnable {
		...
		public SocketClient(int id, String nick, OutputStream os, InputStream is) {
			this.nick = nick;
			this.id = id;
