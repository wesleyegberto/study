...
class MediaPanel extends JPanel
{
	public MediaPanel(URL mediaURL)
	{
		...
		{
			System.err.println("No media player found"); //Não foi localizado um player que pudesse reproduzir o arquivo
		} // end catch
		catch(CannotRealizeException cannotRealizeException)
		{
			System.err.println("Could not realize media player"); //Não pode identificar adequadamente os recursos que o arquivo mídia precisa
		} // end catch
