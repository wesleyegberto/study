...
public class Tree<T extends Comparable<T>>
{
	...
	private void swampFatherNodeByLess(TreeNode<T> fatherCurrentNode, TreeNode<T> currentNode)
	{
		...
		TreeNode<T> swampNode = currentNode; //Contém a referência que será removida
		TreeNode<T> nextNode = currentNode.leftNode; // Contém a referência que será trocada
		TreeNode<T> backNode = fatherCurrentNode; // Armazenará o nó anterior ao nextNode para receber o filho a esqueda do mesmo caso exista
	...
	{
		TreeNode<T> nextNode = swamp.leftNode; // Contém a referência que será trocada
		TreeNode<T> backNode = swamp; // Armazenará o nó anterior ao nextNode para receber o filho a esqueda do mesmo caso exista
