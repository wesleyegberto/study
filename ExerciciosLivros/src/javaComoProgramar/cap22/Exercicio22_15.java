 ...
 * Simulação de fila de supermercado
 */
...
public class Exercicio22_15
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		Random rnd = new Random(); //Um cliente terminará de ser atendido a cada 1 a 4 minutos
		...
		for(int i = 1; i <= 720; i++)
		{
			...
			System.out.println("\t\tAtual: " + i + "; Prox: " + timeProxCli + "; Falta: " + caixa.clienteAtendimento.tempoRestante + "; Num. Fila: " + fila.length);
			if(timeProxCli == i)
			{
